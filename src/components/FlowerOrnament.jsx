...
const FlowerOrnament = ({ className }) => (
  <div className={className} style={styles.container}>
    ...
    >
      ...
      <path d="M120 5 L330 5 M120 595 L330 595 M5 120 L5 480 M445 120 L445 480" stroke="#FFFFFF" strokeWidth="0.5" opacity="0.3" />

      {/* Titik Dekoratif Utama */}
      <circle cx="225" cy="5" r="4" fill="#FFFFFF" opacity="0.6" />
      <circle cx="225" cy="595" r="4" fill="#FFFFFF" opacity="0.6" />
      <circle cx="5" cy="300" r="3" fill="#FFFFFF" opacity="0.4" />
      <circle cx="445" cy="300" r="3" fill="#FFFFFF" opacity="0.4" />
    </svg>
  </div>
);
